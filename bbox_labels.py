...
def yolo_data_generator(image_folder, label_folder, batch_size=32, target_size=(128, 128)):
    ...
    while True:  # Infinite loop for Keras generator
        for i in range(0, num_samples, batch_size):
            ...
            image_to_show = batch_images[0] * 255.0  # Rescale to 0-255 for visualization
            ...
            for bbox, class_id in zip(batch_bboxes[0], batch_classes[0]):
...
def main():
    ...
    image_folder = 'C:/Users/___user___/Documents/Projects/box_detect/train/images'  # Replace with the actual path to your images
    label_folder = 'C:/Users/___user___/Documents/Projects/box_detect/train/labels'  # Replace with the actual path to your labels
